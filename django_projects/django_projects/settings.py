...
from constants import HOST_EMAIL, HOST_PASSWORD
...
SECRET_KEY = 'django-insecure-i5b^h7b=eym0_ewje5c)&82t5ezaqpziw_#sq84)b)%pp^n0tc'
...
STATIC_URL = 'django_projects/static/'
